...
A completed research run usually looks like this:
...
- `artifact_search_results.json`: last artifact search result.
...
runs/<run-id>/
  ...
  code_task/
    ...
    meta/
      ...
      proposed_edits.json
      applied_edits.json
      pre_patch_manifest.json
      post_patch_manifest.json
