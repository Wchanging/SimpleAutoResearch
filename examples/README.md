...
| [Continual learning](continual_learning/README.md) | Mammoth/CIFAR-100 research improvement | Prepare server project, data and interpreter paths, then run the case's research config |
...
- `.local/cases/<case>/`: optional ignored machine-specific configuration; use absolute
  asset/output paths when copying research configs away from their original location.
