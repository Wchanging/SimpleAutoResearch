    ...
    *,
    ...
    return {
        ...
        "experiment": {
            ...
            "metrics": results.get("metrics", {}),
            "guard_status": (results.get("guard") or {}).get("status") if isinstance(results.get("guard"), dict) else None,
            "code_review_status": (results.get("code_review") or {}).get("status") if isinstance(results.get("code_review"), dict) else None,
            "code_task": plan.get("code_task", {}),
        },
        "papers": [
            {
