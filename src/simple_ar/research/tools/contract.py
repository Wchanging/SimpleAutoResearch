    ...
    *,
    ...
    return {
        ...
        "inputs": {
            ...
            "tool_context": "02-search/evidence/tool_context.json",
        },
        "permissions": {
            "read_artifacts": [
                "02-search/evidence/**",
            ...
            "write_artifacts": [
                "02-search/tools/tool_trace.jsonl",
            ],
            "network": False,
            "shell": False,
...
def external_agent_backend_markdown(
    *,
    ...
    lines = [
        ...
        "",
        "- Input artifacts:",
        "  - `02-search/evidence/tool_context.json`",
        "  - `02-search/evidence/experiment_contract.json`",
        ...
        "categories": {
            "run_artifacts": {
                ...
                "paths": [
                    ...
                    "02-search/evidence/evidence_pack.md",
                    "02-search/evidence/experiment_contract.md",
                ],
            ...
            "trace_artifacts": {
                ...
                "paths": [
                    ...
                    "02-search/evidence/decision_log.jsonl",
                    "02-search/tools/tool_trace.jsonl",
                ],
            ...
            "debug_artifacts": {
                ...
                "paths": [
                    ...
                    "02-search/governance/artifact_retention_policy.json",
                ],
