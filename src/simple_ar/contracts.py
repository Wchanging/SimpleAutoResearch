...
CONTRACTS: dict[Stage, StageContract] = {
    ...
    Stage.SEARCH: StageContract(
        ...
        outputs=(
            ...
            "traces/retrieval_rounds.jsonl",
            "traces/screening_decisions.jsonl",
            ...
            "cards/claim_cards.jsonl",
            "papers.jsonl",
            "search_meta.json",
        ),
        description="Plan research questions, retrieve/screen metadata, check coverage, and collect papers.",
    ),
